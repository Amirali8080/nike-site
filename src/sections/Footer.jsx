...
function Footer() {
  return (
    <footer className="max-container">
      ...
      <div className="mt-24 flex justify-between gap-4 text-white-400 max-sm:flex-col max-sm:items-center ">
        <div className="flex  cursor-pointer items-center justify-start gap-2 font-montserrat">
          <img
            src={copyrightSign}
            alt="copyright sign"
            width={20}
